...
<?php foreach ($apps as $app): ?>
                    ...
                    <p class="text-right">
                        <button class="btn btn-success btn-sm toBuy" value="<?=$app->id_app?>" ><strong>$<?= $app->price ?> To Buy</strong></button>    
...
var idApp = $(this).val();
$.post("index.php?r=purchase/create",
    {
        id_app: idApp
    },
    function(response){
